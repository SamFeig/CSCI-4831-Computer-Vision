...
\begin{enumerate}
	...
	For K-Means:
	Increasing the number of clusters drastically increases the run-time of the segmentation. 
	
	
	For HAC:
	Increasing the Resize/Max Pixels value slows the algorithm down to a crawl and requires much more RAM to compute the segmentation. 
