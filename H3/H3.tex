...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Unlike in part A, these transformations of the images actually changed individual pixel value,s and therefore had a more noticeable effect on the results of the corner detection algorithm. 
